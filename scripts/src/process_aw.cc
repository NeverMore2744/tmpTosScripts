...
int main(int argc, char** argv) {
  ...
  FILE* fout = fopen("raw_time.data", "w");
  FILE* fout3 = fopen("waw_time.data", "w");
  int num_logs = 0;

  fprintf(fout, "log timeInSec cnts\n"); 
  fprintf(fout3, "log timeInSec cnts\n");
  
  FILE* fout1_2 = fopen("raw_time_pcts.data", "w");
  FILE* fout3_2 = fopen("waw_time_pcts.data", "w");
  ...
  FILE* fout1g = fopen("raw_time_global_pct.data", "w");
  FILE* fout3g = fopen("waw_time_global_pct.data", "w");
