...
class Processor : Processor_base {
  ...
  public:
    void analyze(const char* file_prefix, const char* volume_file) {
      filenames_.push_back("total_traffic.data");
      filenames_.push_back("per_device_traffic.data");
      filenames_.push_back("active_devices.data");
      filenames_.push_back("interfered_minutes.data");
      filenames_.push_back("active_days.data");
      filenames_.push_back("per_device_per_hour_traffic.data");
      ...
      FILE* fout5 = fopen(filenames_[4].c_str(), "w");
      FILE* fout6 = fopen(filenames_[5].c_str(), "w");
